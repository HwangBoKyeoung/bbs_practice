	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			<sec:authorize access="isAnonymous()">
				<span class="mr-2 d-none d-lg-inline text-gray-600 small">Who are you?</span>
			</sec:authorize>
			<sec:authorize access="isAuthenticated()">
				<span class="mr-2 d-none d-lg-inline text-gray-600 small"><sec:authentication property="principal.username" /></span>
			</sec:authorize>
					<img class="img-profile rounded-circle"
				src="${path}/img/undraw_profile.svg"></a> <!-- Dropdown - User Information -->
			<div
				...
				<sec:authorize access="isAnonymous()">
					<a class="dropdown-item" href="userLoginForm.do"> <i
						class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>로그인
					</a>
				</sec:authorize>
				<sec:authorize access="isAuthenticated()">
